...
class InsectProvider(IdentificationProvider):
    ...
    Primary Engine: BioCLIP 2 TreeOfLifeClassifier with Arthropoda / Insecta taxonomy filtering.
    Fallback Engine: PyTorch Pretrained Insecta Vision Classifier.
    ...
    def identify(
        ...
        # 1. Try BioCLIP 2 Insecta Vision Engine
        try:
        ...
        # 2. Fast Local PyTorch ResNet50 Fallback
        try:
